                                ...
                                if target_school != school : #ensure sch swapped is diff
                                    ...
                                    for member, member_school in enumerate(school_of_each_group[group]):#iterate thru problem grp till we find the sch to swap
                                        ...
                                        if member_school == school and temp_list[target_group][target_member]['Gender'] == temp_list[group][member]['Gender']:
                                            ...
                                            '''
                                            before_original = []
                                            for i in temp_list[group]:
                                                before_original.append(i['School'])
                                            print(f'before_original', before_original)

                                            before_target = []
                                            for item in temp_list[target_group]:
                                                before_target.append(item['School'])
                                            ...
                                            #testing print 
                                            after_original = []
                                            for j in temp_list[group]:
                                                after_original.append(j['School'])
                                            print(f'after_original',after_original)

                                            after_target = []
                                            for items in temp_list[target_group]:
                                                after_target.append(items['School'])
                                            print(f'after_target', after_target)
                                            '''
                                            ...
                                            #check both swap conditions and more than or equal 4 numbers originally                                
